    ...
    return (
        <div className="dark:bg-slate-600 dark:text-white">
            ...
            <div className="p-4 bg-white dark:bg-slate-600 dark:text-white">
                <h1><span className="text-sky-400 mr-3 lg:ms-12 text-xl font-semibold"><Link to='/'><u>Home</u></Link></span>&gt;&gt;<span className="text-slate-500 dark:text-white text-xl mx-3 font-semibold">FAQs</span></h1>
            </div>
            ...
            <div className="bg-white py-10 dark:bg-slate-600 dark:text-white">
                <div className="lg:mx-28 md:mx-20 mx-4 pt-20">
                    <div className="lg:flex md:flex gap-10">
                        <div className="lg:w-1/2 md:w-1/2 mb-4">
                            <h1 className="text-primary dark:text-white  text-4xl font-semibold py-3 ">General Questions</h1>
                            <span>
                                <h1 className=" text-2xl font-semibold py-3 "> Getting started with RackUp</h1>
                                <p className="text-slate-500 dark:text-white text-justify ">Congue leo metus. Vitae arcu mollis blandit ultrice ligula egestas magna suscipit lectus magna suscipit luctus undo blandit</p>
                            </span>
                            <span>
                        ...
                        <div className="lg:w-1/2 md:w-1/2 mb-4">
                            <h1 className="text-primary dark:text-white text-4xl font-semibold py-3 ">Data Sync Backup</h1>
                            <span>
                                <h1 className=" text-2xl font-semibold py-3 "> How do I download videos from online viewing?</h1>
                                <p className="text-slate-500 dark:text-white text-justify">Etiam sit amet mauris suscipit sit amet in odio. Integer congue leo metus. Vitae arcu mollis blandit ultrice ligula egestas at suscipit lectus magna suscipit luctus undo blandit vitae purus</p>
                            </span>
                            <span>
                ...
                <div className="lg:mx-28 md:mx-20 mx-4 py-10">
                    <div className="lg:flex md:flex gap-10">
                        <div className="lg:w-1/2 md:w-1/2 mb-4">
                            <h1 className="text-primary dark:text-white text-4xl font-semibold py-3 ">Coming Soon Features</h1>
                            <span>
                        ...
                        <div className="lg:w-1/2 md:w-1/2 mb-4">
                            <h1 className="text-primary dark:text-white text-4xl font-semibold py-3 ">Pricing Questions</h1>
                            <span>
