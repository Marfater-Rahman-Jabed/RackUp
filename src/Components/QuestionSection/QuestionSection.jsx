                ...
                <Fade direction="up" delay={500}>
                    <div className="collapse   items-center bg-base-200  border-none rounded-none">
                        ...
                        <div className="collapse-title text-2xl font-bold  ">
                            <h1>Do you want a free trial?</h1>
                        </div>
                    ...
                    <div className="collapse collapse-plus  items-center bg-base-200  border-none rounded-none">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-2xl font-bold  ">
                            <h1>Have a busineed don&apos;t how to upadte it?</h1>
                        </div>
                        <div className="collapse-content">
                    ...
                    <div className="collapse collapse-plus  items-center bg-base-200  border-none rounded-none">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-2xl font-bold  ">
                            <h1>Need Some Consultation! Try it for free?</h1>
                        </div>
                        <div className="collapse-content">
                    ...
                    <div className="collapse collapse-plus  items-center bg-base-200  border-none rounded-none">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-2xl font-bold  ">
                            <h1>Turn your ideas into works of art ! Let&apos;s go !</h1>
                        </div>
                        <div className="collapse-content">
                    ...
                    <div className="collapse collapse-plus  items-center bg-base-200  border-none rounded-none">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-2xl font-bold  ">
                            <h1>Will there be a RackUp Android app?</h1>
                        </div>
                        <div className="collapse-content">
