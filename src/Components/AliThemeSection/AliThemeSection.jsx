...
const AliThemeSection = () => {
    return (
        ...
        <div className='shadow-2xl bg-slate-800 pb-10'>
            ...
            <div className="grid  lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-4 lg:mx-40 md:mx-4 mx-10 pb-4">
                <Fade duration={1000}>
                                ...
                                <a href="">
                                    <u className='text-slate-500 '>
                                        <span className='flex mr-4'>
                                            <AiFillApple className='text-slate-500 pt-1 lg:text-2xl text-4xl'></AiFillApple>
                                            <h1 className='text-slate-500 lg:text-xl text-2xl'>IOS</h1>
                                        </span>
                                    </u>
                                </a>
                                <a href="">
                                    <u className='text-slate-500 '><span className='flex mr-4'>
                                        <AiFillAndroid className='pt-1 lg:text-2xl text-4xl text-slate-500'></AiFillAndroid>
                                        <h1 className='text-slate-500 lg:text-xl text-2xl '>Android</h1>
                                    </span></u>
                                </a>
                                <a href="">
                                    <u className='text-slate-500 '><span className='flex '>
                                        <BsWindows className='pt-2  mx-1 text-slate-500 lg:text-xl text-3xl'></BsWindows>
                                        <h1 className='text-slate-500 lg:text-xl text-2xl '>Windows</h1>
                                    </span></u>
                                </a>
                            </div>
                        </div>
                ...
                <Fade delay={1000} duration={1000}>
                    <div className="card lg:w-80 md:w-60 bg-white shadow-2xl">
                        ...
                        <div className="card-body items-center text-center">
                            ...
                            <h1>Finance</h1>
                            <p>Struggling with the challenges of maintaining your enterprise?.We will try. </p>
                            <div className='lg:flex justify-between'>
