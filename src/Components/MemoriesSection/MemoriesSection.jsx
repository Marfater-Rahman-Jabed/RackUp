        ...
        <div className="bg-slate-800  shadow-2xl">
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-4 pt-24 lg:ms-28 md:ms-4 px-28'>
                <div >
                    ...
                    <h1 className='text-white ms-12 pt-2 font-semibold text-xl'>Register</h1>
                </div>
                <div >
                    <span className="rounded-full bg-slate-700 flex justify-center items-center w-40 h-40 ">
                        <img src={Customize} alt="" className='   w-24 h-24' />
                    </span>
                    <h1 className='text-white ms-12 pt-2 font-semibold text-xl'>Customize</h1>
                </div>
                <div >
                    <span className="rounded-full bg-slate-700 flex justify-center items-center w-40 h-40 ">
                        <img src={Connect} alt="" className='   w-24 h-24' />
                    </span>
                    <h1 className='text-white ms-12 pt-2 font-semibold text-xl'>Connect</h1>
                </div>
